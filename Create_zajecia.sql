CREATE OR REPLACE FUNCTION mapuj_typ_przedmiotu_na_sale (typ_przedmiotu VARCHAR2) RETURN VARCHAR2
  AS
  BEGIN
    CASE typ_przedmiotu
...
CREATE OR REPLACE PROCEDURE utworz_zajecia (dzien_tygodnia INTEGER, godz_rozpoczecia TIMESTAMP)
AS
...
CREATE OR REPLACE PROCEDURE utworz_zajecia_dla_przedmiotow (
